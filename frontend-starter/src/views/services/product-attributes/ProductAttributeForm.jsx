import {CardHeader, DefaultLayout, Loader} from "../../../components/index.js";
...
const ProductAttributeForm = () => {
  ...
  const getProductAttribute = async () => {
    setLoading(true)
    await axiosClient.get(`/product-attributes/${id}`).then(res => {
      setLoading(false)
      setInput(res.data)
  ...
  const handleSubmit = (e) => {
    ...
    return (
      <DefaultLayout title={id ? `Edit Product Attribute` : 'Add Product Attribute'}>
        <section className="content">
          <div className="container-fluid">
            <div className="row">
              <div className="col-12">
                <div className="card">
                  <CardHeader isForm title={id ? 'Edit Product Attribute' : 'Add Product Attribute'} link='/product-attributes' />
                  {/* /.card-header */}
